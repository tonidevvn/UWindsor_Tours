...
public class IngameSettingsMenu : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        settingsMenu = root.Q<VisualElement>("ingame-settings-menu"); // assumes you add a VisualElement with this name
        ...
        backButton.clicked += ReturnToGame;
    }

    void Start()
    {
        Debug.Log("IngameSettingsMenu started");
    ...
    public void Hide()
    {
        Debug.Log("Settings closed (in-game)");
        settingsMenu.style.display = DisplayStyle.None;
    }
}
